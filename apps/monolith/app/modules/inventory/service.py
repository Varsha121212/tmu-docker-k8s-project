"""Public boundary for the Inventory module.

Other modules (Cart, Order) must call these functions - never
app.modules.inventory.internal directly. When Inventory is extracted into its own
service, these signatures become the HTTP contract (POST /reserve, POST /release).
"""
