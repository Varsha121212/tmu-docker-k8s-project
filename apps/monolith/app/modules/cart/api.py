...
def get_cart(
    ...
    cart = service.get_cart(redis_client, db, user_id=current_user_id)
...
def clear_cart(
    ...
    # SDD 7.4: "Internal call after successful order." Directly reachable by the owning
    # customer today; Order's checkout flow (Cart epic Period 1, Order epic not yet built)
    # will call app.modules.cart.service.clear_cart(...) in-process, not this HTTP route.
