"""Public boundary for the Catalog module.

Other modules (Cart, Order) must call these functions - never
app.modules.catalog.internal directly - to look up authoritative price/existence.
When Catalog is extracted into its own service, these signatures become the HTTP contract.
"""
